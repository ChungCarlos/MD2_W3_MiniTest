            ...
            switch (luaChon) {
                case 1: {
                    ...
                    if (num == 1) {
                        ...
                        int soDienThoai = new Scanner(System.in).nextInt();
                        ...
                        double thuongFull = new Scanner(System.in).nextDouble();
                        System.out.println("Nhập tiền phạt: ");
                        double phatFull = new Scanner(System.in).nextDouble();
                        System.out.println("Nhập tiền bảo hiểm: ");
                        double baoHiem = new Scanner(System.in).nextDouble();
                        ...
                        double soGio = new Scanner(System.in).nextDouble();
                        System.out.println("Nhập số tiền thưởng trong tháng: ");
                        double thuongPart = new Scanner(System.in).nextDouble();
                        System.out.println("Nhập số tiền phạt trong tháng: ");
                        double phatPart = new Scanner(System.in).nextDouble();
